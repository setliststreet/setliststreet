    ...
    <MainLayout>
      ...
      <div className="container mx-auto px-4 py-8">
        <h1 className="text-4xl font-bold text-center text-purple-800 mb-8">
          Guess the Post Drums/Space Song
        </h1>
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-lg shadow-lg p-6">
              ...
              <div className="text-gray-600">
                <p className="mb-2">[PLACEHOLDER - Post drums/space-specific hints to be added later]</p>
                <ul className="list-disc list-inside space-y-1 text-sm">
                  <li>Common post-space songs</li>
                  <li>Re-entry favorites</li>
                  <li>High-energy comebacks</li>
                  <li>Space-landing patterns</li>
                </ul>
              </div>
            </div>
          </div>
