        ...
        <div className="container mx-auto px-6 py-8">
          ...
          <div className="grid grid-cols-1 xl:grid-cols-4 gap-8 mb-8">
            ...
            <div className="xl:col-span-3 space-y-6">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className="lg:col-span-2">
                  <div className="bg-purple-50 border border-purple-200 rounded-lg p-3 text-center">
                    <h3 className="text-lg font-semibold text-purple-800 mb-1">🥁 Drums / Space 🚀</h3>
              ...
              {/* Play Mode Selection */}
              <div className="mt-8">
                <h2 className="text-xl font-bold text-gray-800 mb-4">Choose Your Play Mode</h2>
            ...
            <div className="xl:col-span-1 space-y-4">
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 sticky top-4">
                ...
                <div className="space-y-3 text-sm">
                  <div>
                    <h4 className="font-semibold text-blue-700 text-sm">Most Common Openers:</h4>
                  ...
                  <div>
                    <h4 className="font-semibold text-blue-700 text-sm">Common Set 1 Closers:</h4>
                    <ul className="text-blue-600 text-xs mt-1 space-y-1">
                      <li>• Cassidy (14%)</li>
                      <li>• Deal (12%)</li>
                  ...
                  <div>
                    <h4 className="font-semibold text-blue-700 text-sm">Popular Pairings:</h4>
                    <ul className="text-blue-600 text-xs mt-1 space-y-1">
