    ...
    <header className="bg-white border-b-2 border-gray-200 sticky top-0 z-[100] w-full shadow-md">
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
        <div className="flex justify-between items-center h-18">
          ...
          {/* Navigation Links - Always Visible with Better Styling */}
          <nav className="flex items-center space-x-2 lg:space-x-4">
            ...
            <Link 
              href="/register" 
              className="bg-purple-600 text-white hover:bg-purple-700 px-6 py-2 text-sm font-semibold rounded-lg transition-all border-2 border-purple-600 hover:border-purple-700 shadow-md hover:shadow-lg"
            >
              Sign Up
            </Link>
          </nav>
